...
if __name__=="__main__":
    ...
    parser.add_argument('-user', help="Provider/User like AkihitoSubsWeeklies, and YuiSubs", type=str)
    parser.add_argument('-category', help="Get specific Category for it, Check readme for this", type=int)
